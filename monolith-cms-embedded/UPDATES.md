...
curl -fsSL https://raw.githubusercontent.com/zundIO/cms/main/lib/storage.js -o lib/cms/storage.js
curl -fsSL https://raw.githubusercontent.com/zundIO/cms/main/pages/cms.js -o pages/cms.js
```
...
// In pages/cms.js:
useEffect(() => {
  fetch('https://api.github.com/repos/zundIO/cms/commits/main')
    .then(r => r.json())
    .then(data => {
...
- [ ] Gehe zu: https://github.com/zundIO/cms/settings
